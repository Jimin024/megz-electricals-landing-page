      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            <p className="text-sm font-bold text-accent tracking-wider uppercase mb-3">Our Portfolio</p>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black">Featured Installations</h2>
          </div>
